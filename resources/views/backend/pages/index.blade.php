            ...
            <div class="dd3-content">
                ...
                <span class="content-right">
                    <a href="#launch-pricing-modal"
                       ...
                       onclick="view('{{ $item->id }}','{{ $item->title }}','{{ $item->slug }}','{{ $item->display }}','{{ $item->feature }}','{{ $item->content }}')"
            ...
            <div class="col-lg-12">
                ...
                <ul class="nav nav-tabs">
                    <li class="nav-item"><a class="nav-link show  active" data-toggle="tab" href="#Pages">All
                            @if($page) {{ $page->title }} @else Pages @endif</a>
                    </li>
                    <li class="nav-item"><a class="nav-link" data-toggle="tab"
                                            href="#addPage">Add @if($page) {{ $page->title }} @else Pages @endif</a>
                    </li>
                </ul>
                <div class="tab-content mt-0">
                    ...
                    <div class="tab-pane" id="addPage">
                        <div class="card">
                            <div class="header card-header">
                                <h6 class="title mb-0">Add @if($page) {{ $page->title }} @else Pages @endif</h6>
                            </div>
                            <div class="body mt-2">
