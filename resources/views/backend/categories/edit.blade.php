...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-12">
                <form method="POST" action="{{ route('categories.update',base64_encode($categories->id)) }}"
                        ...
                        <div class="body">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="title"
                                               placeholder="Title"
                                               aria-label="Title"
                                               aria-describedby="basic-addon1" value="{{ $categories->title }}"
                                               required>
                                    </div>
                                </div>
                                {{--  <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><input type="checkbox" name="status"
                                                                                  value="1"
                                                                                  @if($categories->status == 1)checked @endif></span>
                                        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend ">
                                            <span class="input-group-text"><input type="checkbox" name="feature"
                                                                                  value="1"
                                                                                  @if($categories->feature == 1)checked @endif></span>
                                        </div>
                                ...
                                {{--<div class="col-md-12">
                                    <div class="input-group mb-3">
                                        ...
                                        <textarea rows="5" class="form-control" name="description"
                                                  aria-label="With textarea">{{ $categories->description }}</textarea>
                                    </div>
                                </div>
                            </div>--}}
                            </div>
